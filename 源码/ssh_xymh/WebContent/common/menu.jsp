<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <style>
				...
				<div class="min">					
					<div class="tc_login">											
						<div class="login_register">
							<form method="POST" name="form_login" target="_top" action="/ssh_xymh//login/toLogin.do">
								<div align="center">
		...
		<!--nav start-->
		<div class="nav_menu">
			<a href="/ssh_xymh//login/index.do" class="logo fl"><img src="" /><span style="font-size: 50px">校园门户网站</span></a>
			<div class="nav_list fr">
				<ul id="nav" class="nav clearfix">
					<li class="nLi"></li>
					<li class="nLi">
						<h3><a href="/ssh_xymh//news/findByObj2.do">新闻快讯</a></h3>
					</li>
					<li class="nLi">
						<h3><a href="/ssh_xymh//notice/findByObj2.do">通知公告</a></h3>
					</li>
					<li class="nLi">
						<h3><a href="/ssh_xymh//xl/findByObj2.do">校历</a></h3>
					</li>
					<li class="nLi">
						<h3><a href="/ssh_xymh//schoolJob/findByObj2.do">求职招聘</a></h3>
					</li>
					<li class="nLi">
						<h3><a href="/ssh_xymh//xkzy/findByObj2.do">学科资源</a></h3>
					</li>
			</div>
			<div class="clear"></div>
		</div>