	...
	private User addUser;//添加人 -->
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="/ssh_xymh//news/update.do?id=${data.id}"><span class="icon-edit"></span>修改</a> 
      ...
      <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="/ssh_xymh//news/findByObj.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:last>  
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location.href="/ssh_xymh//news/delete.do?id="+id;
	}
}
function DelSelect(){
	var Checkbox=false;
