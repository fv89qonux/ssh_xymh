        ...
        <div class="cml-g">
            <div class="">
                   <div class="cm-article">
                       <!-- <div class="cm-title">
                           <div class="cm-title-nav">当前位置：<span><a href="#">网站首页</a></span>><span><a href="#">资质荣誉</a></span>><span>公司动态</span></div>
                       </div> -->
                       <ol class="breadcrumb">
							<li><a href="#">网站首页</a></li>
                       ...
                       <div class="cm-new-list cm-content">
                               <ul  class="cm-new-list-ul">
                               		<c:forEach items="${pagers.datas }" var="honor">
                               			<li><a href="/ssh_xymh//honor/detail.do?id=${honor.id}"><span>${honor.title }</span><i><fmt:formatDate value="${honor.addTime}" type="both"/></i></a></li>
                               		</c:forEach>
                               </ul>
