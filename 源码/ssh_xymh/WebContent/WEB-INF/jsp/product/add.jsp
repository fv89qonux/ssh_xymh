...
<div class="panel admin-panel margin-top">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>产品添加</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="/ssh_xymh//product/exAdd.do" enctype="multipart/form-data"> 
            ...
            <select name="type" class="input w50">
              <option value="">请选择类型</option>
               <c:forEach items="${typeList}" var="data" varStatus="l">
               		<option value="${data.id}" selected="selected">${data.title }</option>
