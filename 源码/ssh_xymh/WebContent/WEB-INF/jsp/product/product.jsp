...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search">
        <li>
           <a class="button border-main icon-plus-square-o" href="${ctx }/product/add.do"> 添加</a> 
        </li>
         <li>
          </li>
      </ul>
	...
	private User addUser;//添加人 -->
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="/ssh_xymh//product/update.do?id=${data.id}"><span class="icon-edit"></span>修改</a> 
      ...
      <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="/ssh_xymh//product/findByObj.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:last>  
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location.href="/ssh_xymh//product/delete.do?id="+id;
	}
}
function DelSelect(){
	var Checkbox=false;
