   ...
   <title>易购后台管理中心</title>  
    ...
    <script src="/ssh_xymh//resource/js/jquery.js"></script>
     <script src="/ssh_xymh//resource/js/pintuer.js"></script>  
      <script type="text/javascript" src="/ssh_xymh//resource/js/ueditor/ueditor.config.js"></script>
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="/ssh_xymh//resource/js/ueditor/ueditor.all.min.js"></script> 
</head>
<style>
    .file1 {
        position: relative;
...
<div class="panel admin-panel margin-top">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改产品类型</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="/ssh_xymh//proType/exUpdate.do" enctype="multipart/form-data"> 
    <input type="hidden" name="id" value="${obj.id}">  
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="title"  data-validate="required:请输入产品类型" value="${obj.title }"/>         
          <div class="tips"></div>
        </div>
      </div> 
     <div class="form-group">
